package com.dicoding.mynotesappmodul4.adapter;
...
import com.dicoding.mynotesappmodul4.CustomOnItemClickListener;
import com.dicoding.mynotesappmodul4.NoteAddUpdateActivity;
import com.dicoding.mynotesappmodul4.R;
...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteViewHolder> {
    ...
    // method menambahkan item pada cardView
    public void addItem(Note note) {
        this.listNotes.add(note);
        notifyItemInserted(listNotes.size() - 1);
    }

    // method memperbaharui item pada cardView
    public void updateItem(int position, Note note) {
        this.listNotes.set(position, note);
        notifyItemChanged(position, note);
    }

    // method menghapus item pada cardView
